...
import type { UsuarioAdminDto, CrearUsuarioPorAdminDto } from '../../types/admin'; // Asegúrate que CrearUsuarioPorAdminDto esté aquí
...
import ModalCrearUsuario from '../../components/admin/ModalCrearUsuario'; // <-- NUEVA IMPORTACIÓN
...
const GestionUsuariosPage: React.FC = () => {
  ...
  const [showCrearUsuarioModal, setShowCrearUsuarioModal] = useState<boolean>(false); // <-- NUEVO ESTADO
                ...
                {usuarios.map((usuario) => (
                  <tr key={usuario.id}>
                    ...
                    <td className="text-center">
                      {usuario.estaActivo ? (
                        <Badge bg="success" pill><CheckCircleFill className="me-1" /> Sí</Badge>
                      ) : (
                        <Badge bg="danger" pill><XCircleFill className="me-1" /> No</Badge>
                      )}
                    </td>
