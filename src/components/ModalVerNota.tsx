...
const ModalVerNota: React.FC<ModalVerNotaProps> = ({
  ...
  return (
    <Modal show={show} onHide={handleModalClose} size="xl" centered backdrop="static">
      ...
      <Modal.Body>
        <Row>
          <Col md={previewType ? 5 : 12}>{/* Si no esta abierta la previsualización de archivos esta columna debe ocupar 12 */}
